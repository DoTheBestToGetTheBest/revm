...
## [5.0.0](https://github.com/DoTheBestToGetTheBest/revm/compare/revm-primitives-v4.0.0...revm-primitives-v5.0.0) - 2024-06-02
...
### Fixed
- *(primitives)* specify the optimism cfg on spec_to_generic ([#1412](https://github.com/DoTheBestToGetTheBest/revm/pull/1412))
