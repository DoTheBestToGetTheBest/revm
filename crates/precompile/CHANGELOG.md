...
## [8.0.0](https://github.com/DoTheBestToGetTheBest/revm/compare/revm-precompile-v7.0.0...revm-precompile-v8.0.0) - 2024-06-02

### Added
- *(optimism)* Add secp256r1 precompile for Fjord ([#1436](https://github.com/DoTheBestToGetTheBest/revm/pull/1436))

### Fixed
- check canonical Fp elements ([#1434](https://github.com/DoTheBestToGetTheBest/revm/pull/1434))
- *(precompile)* ignore infinity points in G1 MSM ([#1432](https://github.com/DoTheBestToGetTheBest/revm/pull/1432))
- *(precompile)* BLS G2 MSM ([#1428](https://github.com/DoTheBestToGetTheBest/revm/pull/1428))

### Other
- add test for map_fp_to_g1 precompile ([#1465](https://github.com/DoTheBestToGetTheBest/revm/pull/1465))
- add docs for BLS scalar input decoding ([#1446](https://github.com/DoTheBestToGetTheBest/revm/pull/1446))
